            ...
            <div class="products">
                <div class="product">
                    <div class="product-image">
                        <div class="image"> <a href="{{ route('showProduct', $featured_product->slug)  }}"><img
                    ...
                    <div class="product-info text-left">
                        <h3 class="name"><a href="{{ route('showProduct', $featured_product->slug)  }}">{{ $featured_product->name }}</a>
                        </h3>
                        ...
                        <div class="action">
                            <ul class="list-unstyled">
                                <li class="add-cart-button btn-group">
                                    ...
                                    data-toggle="modal" data-target="#addToCart" id="{{ $featured_product->id }}" onclick="productView({{ $featured_product->id }})"> <i
                                ...
                                {{-- <li class="lnk"> <a data-toggle="tooltip" class="add-to-cart"
                                        href="{{ route('showProduct', $featured_product->slug)  }}" title="Compare"> <i class="fa fa-signal"
